...
- `Edit energy` is recommended automatically after music analysis. Calm merges more small cuts, Balanced follows strong rhythm changes, and Aggressive keeps more fills/drop hits.
